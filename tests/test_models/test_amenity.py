#!/usr/bin/env python3
"""this is Unittest module for the Amenity Class."""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_class_exists(self):
        """verify whether class exists"""
        res = "<class 'models.amenity.Amenity'>"
        self.assertEqual(str(type(self.a)), res)

    def test_user_inheritance(self):
        """Check whether Amenity is a derived class of BaseModel"""
        self.assertIsInstance(self.a, Amenity)

    def test_types(self):
        """Verifies whether the attribute's type is accurate"""
