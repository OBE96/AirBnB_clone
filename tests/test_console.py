#!/usr/bin/python3
"""Specifies unit tests for console.py.
Unit test classes:
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unit tests to assess the prompting functionality of the HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unit tests for examining the help messages of the HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unit tests for evaluating the process of exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unit tests for evaluating the 'create' command in the HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    """Unit tests for evaluating the 'destroy' command in the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unit tests for assessing the 'all' command in the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unit tests for evaluating the 'update' command in the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unit tests for assessing the 'count' method of the HBNB command interpreter."""
